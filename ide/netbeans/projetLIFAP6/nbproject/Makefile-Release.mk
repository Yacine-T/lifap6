...
${OBJECTDIR}/_ext/52a4beb5/AIScrabble.o: ../../../src/AIScrabble.cpp
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/AIScrabble.o ../../../src/AIScrabble.cpp

${OBJECTDIR}/_ext/52a4beb5/Gaddag.o: ../../../src/Gaddag.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/Gaddag.o ../../../src/Gaddag.cpp

${OBJECTDIR}/_ext/52a4beb5/GaddagNode.o: ../../../src/GaddagNode.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/GaddagNode.o ../../../src/GaddagNode.cpp

${OBJECTDIR}/_ext/52a4beb5/KicksInformation.o: ../../../src/KicksInformation.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/KicksInformation.o ../../../src/KicksInformation.cpp

${OBJECTDIR}/_ext/52a4beb5/LetterBag.o: ../../../src/LetterBag.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/LetterBag.o ../../../src/LetterBag.cpp

${OBJECTDIR}/_ext/52a4beb5/LetterOfPlayer.o: ../../../src/LetterOfPlayer.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/LetterOfPlayer.o ../../../src/LetterOfPlayer.cpp

${OBJECTDIR}/_ext/52a4beb5/LetterPointTable.o: ../../../src/LetterPointTable.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/LetterPointTable.o ../../../src/LetterPointTable.cpp

${OBJECTDIR}/_ext/52a4beb5/Player.o: ../../../src/Player.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/Player.o ../../../src/Player.cpp

${OBJECTDIR}/_ext/52a4beb5/board.o: ../../../src/board.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/board.o ../../../src/board.cpp

${OBJECTDIR}/_ext/52a4beb5/bonus.o: ../../../src/bonus.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/bonus.o ../../../src/bonus.cpp

${OBJECTDIR}/_ext/52a4beb5/main.o: ../../../src/main.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/main.o ../../../src/main.cpp

${OBJECTDIR}/_ext/52a4beb5/spot.o: ../../../src/spot.cpp
	${MKDIR} -p ${OBJECTDIR}/_ext/52a4beb5
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -std=c++11 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/52a4beb5/spot.o ../../../src/spot.cpp
